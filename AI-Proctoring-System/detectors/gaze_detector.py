"""
Gaze detection component for head pose and eye tracking analysis.
"""
...
class GazeDetector(DetectionSource):
    """Detects suspicious head pose and gaze direction using MediaPipe face mesh."""
    
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        """Initialize the gaze detector."""
        self.config = config or {}
        # Simple print-based logging instead of complex logging
        self.logger_name = f"GazeDetector"
        ...
        if MEDIAPIPE_AVAILABLE:
            ...
            self.logger.warning("MediaPipe not available - gaze detection will use fallback method")
    ...
    def start_detection(self) -> None:
        ...
        try:
            ...
            self.total_detections = 0
            self.suspicious_detections = 0
            print("GazeDetector started successfully")
        except Exception as e:
            print(f"Failed to start GazeDetector: {e}")
            self.is_running = False
    ...
    def stop_detection(self) -> None:
        ...
        try:
            if self.face_mesh and MEDIAPIPE_AVAILABLE:
                ...
                self.face_mesh = None
            self.is_running = False
            print("GazeDetector stopped")
        except Exception as e:
            print(f"Error stopping GazeDetector: {e}")
    ...
    def update_config(self, new_config: Dict[str, Any]) -> None:
        ...
        print(f"GazeDetector configuration updated: {new_config}")
